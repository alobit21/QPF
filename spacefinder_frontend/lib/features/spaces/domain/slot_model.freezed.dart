...
mixin _$Slot {
 ...
 String get id; String get officeId; String get date; String get startTime; String get endTime; String get roomNumber; bool get isAvailable;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,officeId,date,startTime,endTime,roomNumber,isAvailable);

@override
String toString() {
  return 'Slot(id: $id, officeId: $officeId, date: $date, startTime: $startTime, endTime: $endTime, roomNumber: $roomNumber, isAvailable: $isAvailable)';
}
...
@useResult
$Res call({
 String id, String officeId, String date, String startTime, String endTime, String roomNumber, bool isAvailable
});
...
/// Create a copy of Slot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? officeId = null,Object? date = null,Object? startTime = null,Object? endTime = null,Object? roomNumber = null,Object? isAvailable = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String officeId,  String date,  String startTime,  String endTime,  String roomNumber,  bool isAvailable)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Slot() when $default != null:
return $default(_that.id,_that.officeId,_that.date,_that.startTime,_that.endTime,_that.roomNumber,_that.isAvailable);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String officeId,  String date,  String startTime,  String endTime,  String roomNumber,  bool isAvailable)  $default,) {final _that = this;
switch (_that) {
case _Slot():
return $default(_that.id,_that.officeId,_that.date,_that.startTime,_that.endTime,_that.roomNumber,_that.isAvailable);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String officeId,  String date,  String startTime,  String endTime,  String roomNumber,  bool isAvailable)?  $default,) {final _that = this;
switch (_that) {
case _Slot() when $default != null:
return $default(_that.id,_that.officeId,_that.date,_that.startTime,_that.endTime,_that.roomNumber,_that.isAvailable);case _:
  return null;
...
class _Slot implements Slot {
  const _Slot({required this.id, required this.officeId, required this.date, required this.startTime, required this.endTime, required this.roomNumber, this.isAvailable = true});
...
/// Create a copy of Slot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? officeId = null,Object? date = null,Object? startTime = null,Object? endTime = null,Object? roomNumber = null,Object? isAvailable = null,}) {
  return _then(_Slot(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,officeId: null == officeId ? _self.officeId : officeId // ignore: cast_nullable_to_non_nullable
as String,date: null == date ? _self.date : date // ignore: cast_nullable_to_non_nullable
