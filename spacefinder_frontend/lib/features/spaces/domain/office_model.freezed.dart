...
mixin _$Office {
 ...
 String get id; String get name; String get description; String get address; String get city; double? get latitude; double? get longitude;@JsonKey(name: 'pricePerHour') double? get pricePerHour; int? get size; int? get availableRooms; List<String>? get images; bool? get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,address,city,latitude,longitude,pricePerHour,size,availableRooms,const DeepCollectionEquality().hash(images),isActive);

@override
String toString() {
  return 'Office(id: $id, name: $name, description: $description, address: $address, city: $city, latitude: $latitude, longitude: $longitude, pricePerHour: $pricePerHour, size: $size, availableRooms: $availableRooms, images: $images, isActive: $isActive)';
}
...
@useResult
$Res call({
 String id, String name, String description, String address, String city, double? latitude, double? longitude,@JsonKey(name: 'pricePerHour') double? pricePerHour, int? size, int? availableRooms, List<String>? images, bool? isActive
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description,  String address,  String city,  double? latitude,  double? longitude, @JsonKey(name: 'pricePerHour')  double? pricePerHour,  int? size,  int? availableRooms,  List<String>? images,  bool? isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Office() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.address,_that.city,_that.latitude,_that.longitude,_that.pricePerHour,_that.size,_that.availableRooms,_that.images,_that.isActive);case _:
  return orElse();
...
class _Office implements Office {
  const _Office({required this.id, required this.name, required this.description, required this.address, required this.city, this.latitude, this.longitude, @JsonKey(name: 'pricePerHour') this.pricePerHour, this.size, this.availableRooms, final  List<String>? images, this.isActive}): _images = images;
...
@override@JsonKey(name: 'pricePerHour') final  double? pricePerHour;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,address,city,latitude,longitude,pricePerHour,size,availableRooms,const DeepCollectionEquality().hash(_images),isActive);
